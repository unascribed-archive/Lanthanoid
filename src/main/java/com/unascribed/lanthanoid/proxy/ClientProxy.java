...
public class ClientProxy implements Proxy {
	...
	public void init() {
		...
		MinecraftForgeClient.registerItemRenderer(LItems.eldritch_chestplate, new EldritchItemRenderer(0.35f, 0.5f, 0f, LItems.eldritch_chestplate::getGlyphs));
		...
		MinecraftForgeClient.registerItemRenderer(LItems.eldritch_boots, new EldritchItemRenderer(0.375f, 0.4f, 90f, LItems.eldritch_boots::getGlyphs));
	}
}
